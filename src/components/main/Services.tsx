...
const Services = () => {
    return (
        ...
        >
            ...
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 lg:gap-10 px-4 sm:px-10 flex-wrap justify-center">
                {/* Service Card 1 */}
                <div className="w-full sm:w-[300px] h-auto sm:h-[350px] rounded-lg shadow-lg border border-[#2A0E61] bg-[#1A1A2E] z-[20] flex flex-col p-6 hover:scale-105 transition-all duration-300">
                    ...
                    <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-200 mb-2 text-center">Web Development</h2>
                ...
                <div className="w-full sm:w-[300px] h-auto sm:h-[350px] rounded-lg shadow-lg border border-[#2A0E61] bg-[#1A1A2E] z-[20] flex flex-col p-6 hover:scale-105 transition-all duration-300">
                    ...
                    <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-200 mb-2 text-center">Mobile Development</h2>
                    <p className="text-sm sm:text-base text-gray-400 text-center">
                ...
                <div className="w-full sm:w-[300px] h-auto sm:h-[350px] rounded-lg shadow-lg border border-[#2A0E61] bg-[#1A1A2E] z-[20] flex flex-col p-6 hover:scale-105 transition-all duration-300">
                    ...
                    <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-200 mb-2 text-center">UI/UX Design</h2>
                    <p className="text-sm sm:text-base text-gray-400 text-center">
