            ...
            <div className="w-full max-w-4xl px-4">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-8 relative border-l-2 border-purple-500 pl-8 ml-4 md:ml-0">
                    ...
                    <div className="flex-1">
                        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white">Senior Frontend Developer</h3>
                        <span className="text-xs sm:text-sm text-gray-400">Tech Company Inc. | 2023 - Present</span>
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-8 relative border-l-2 border-cyan-500 pl-8 ml-4 md:ml-0">
                    ...
                    <div className="flex-1">
                        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white">Full Stack Developer</h3>
                        <span className="text-xs sm:text-sm text-gray-400">Freelance | 2021 - 2023</span>
                        <p className="text-sm sm:text-base text-gray-300 mt-2">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-8 relative border-l-2 border-pink-500 pl-8 ml-4 md:ml-0">
                    ...
                    <div className="flex-1">
                        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-white">Junior Web Developer</h3>
                        <span className="text-xs sm:text-sm text-gray-400">Creative Agency | 2020 - 2021</span>
                        <p className="text-sm sm:text-base text-gray-300 mt-2">
