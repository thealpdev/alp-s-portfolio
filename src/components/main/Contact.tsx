            ...
            <div className="flex flex-col items-center justify-center w-full max-w-2xl px-4 gap-8">
                ...
                <div className="flex flex-col md:flex-row gap-6 w-full justify-center">
                    <a
                        ...
                        className="flex items-center justify-center gap-3 px-8 py-4 rounded-lg bg-gradient-to-r from-purple-900 to-purple-600 text-white font-bold text-lg hover:scale-105 transition-transform duration-300 border border-purple-500"
                    >
