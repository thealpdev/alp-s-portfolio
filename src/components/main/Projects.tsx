...
const Projects = () => {
    return (
        <div
            ...
            id="projects"
        >
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 py-10 lg:py-20 px-4 sm:px-10">
                My Projects
            </h1>
            <div className="h-full w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 px-4 sm:px-10">
                <ProjectCard
                    src="/alp-s-portfolio/canmarkt-new.png"
                ...
                />
                <ProjectCard
                    src="/alp-s-portfolio/growithagro-new.png"
                    title="Growith Agro"
                ...
                />
                <ProjectCard
                    src="/alp-s-portfolio/solenza-new.png"
                ...
                />
                <ProjectCard
                    src="/alp-s-portfolio/simple-v2.png"
                ...
                />
                <ProjectCard
                    src="/alp-s-portfolio/moop-v2.png"
                ...
                />
                <ProjectCard
                    src="/alp-s-portfolio/beast-v2.png"
